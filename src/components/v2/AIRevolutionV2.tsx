...
const AIRevolutionV2 = () => {
    return (
        <section className="py-24 pb-48 relative overflow-hidden bg-background">
            ...
            <div className="wave-divider-dark-light">
