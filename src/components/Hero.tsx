      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <div className="grid grid-cols-3 gap-8 mt-20 pt-12 border-t border-border/50 animate-fade-in" style={{ animationDelay: "0.6s" }}>
            ...
            <div className="text-center">
              <div className="text-3xl md:text-5xl font-bold text-gradient mb-2">#1</div>
              <div className="text-sm md:text-base text-muted-foreground">Google Rankings</div>
            </div>
            <div className="text-center">
              <div className="text-3xl md:text-5xl font-bold text-gradient mb-2">10x</div>
              <div className="text-sm md:text-base text-muted-foreground">Average ROI</div>
            </div>
          </div>
        </div>
      </div>
