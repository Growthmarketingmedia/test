      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="text-center max-w-4xl mx-auto mb-20">
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-primary/10 border border-primary/20 rounded-full mb-6">
            ...
            <span className="text-sm font-semibold text-primary">NEW: AI-Powered Lead Generation</span>
          </div>
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center mb-20">
          ...
          <div className="relative">
            <div className="relative bg-card rounded-3xl border border-border p-8 shadow-2xl">
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="bg-secondary rounded-2xl rounded-tl-sm p-4 max-w-xs">
                    <p className="text-sm">Perfect! We've helped dozens of roofing companies dominate Google. What's your biggest challenge right now - getting found online or converting leads?</p>
                  </div>
                </div>

                {/* Typing indicator */}
                <div className="flex items-center gap-2 text-muted-foreground text-sm pl-13">
            ...
            {/* Stats badge */}
            <div className="absolute -right-4 -bottom-4 bg-card border border-primary/20 rounded-2xl p-4 shadow-xl">
          ...
          <div>
            <div className="space-y-6">
              {features.map((feature, index) => (
                <div
                  key={feature.title}
                  className="flex gap-4 p-6 rounded-2xl bg-card/50 border border-border hover:border-primary/30 transition-all duration-300"
                >
